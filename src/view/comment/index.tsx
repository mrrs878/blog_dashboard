 ...
 * @LastEditTime: 2021-03-05 19:03:58
...
const Comments = () => {
  const [getCommentsLoading, getCommentsRes, , reGetComments] = useRequest(GET_AUTHOR_COMMENTS);
  const [commentListColumns, setCommentListColumns] = useState([]);
  ...
  useEffect(() => {
    ...
    const tmp = getCommentListColumns();
    setCommentListColumns(tmp as any);
  }, [getCommentsRes]);
